file://<WORKSPACE>/zadania_domowe/src/main/scala/dodatkowe.scala
...
action parameters:
uri: file://<WORKSPACE>/zadania_domowe/src/main/scala/dodatkowe.scala
text:
```scala
def myTake(l" )
@main
def zadanie_dodatkowe: Unit = {
